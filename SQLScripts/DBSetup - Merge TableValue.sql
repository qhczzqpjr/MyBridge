...
DECLARE @TargetSchema NVARCHAR(50) = 'dbo'
DECLARE @TableName NVARCHAR(50) = 'LP_GroupAggregates_ForLoanGroups_Extended'
DECLARE @UK1 NVARCHAR(50) = 'loan_id'
DECLARE @UK2 NVARCHAR(50) = ''
